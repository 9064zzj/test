...
public final class ScoreValue {
    ...
    public static final int BLOCK = 10000;
     ...
     public static final int VERYHIGH = 1000;
      /**
      * this value is lower than VERYHIGH,
      * but higher than MEDIUM.
      */
     public static final int HIGH = 500;

      /**
      * this value is lower than HIGH,
      * but higher than LOW.
      */
     public static final int MEDIUM = 100;
         /**
      * this value is lower than MEDIUM,
      * but higher than VERYLOW.
      */
     public static final int LOW = 40;
         /**
      * this value is lower than LOW,
      * but higher than ZERO.
      */
